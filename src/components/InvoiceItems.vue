						...
						<v-col>
							<v-card class="pa-2" flat tile>
								<v-list-item three-line>
									<v-list-item-content>
										<v-list-item-title class="headline mb-1">John Doe</v-list-item-title>
												...
												<v-card-text>
													<v-container>
														<v-row>
															...
															<v-col cols="12">
																<v-text-field :rules="costRules" label="Price" :value="productPrice"></v-text-field>
															</v-col>
															<v-col cols="12">
																<v-text-field :rules="qtyRules" v-model="editedItem.quantity" label="Quantity"></v-text-field>
															</v-col>
														</v-row>
													</v-container>
												</v-card-text>
